 ...
 */
trait OpeningbalanceRelationship
{
   ...
   /* public function group()
    ...
    { 
        return $this->hasMany('App\Models\transaction\Transaction','payer_id')->where('relation_id','=',0)->where('payer_type', '=','supplier')->orWhere('relation_id','=',21)->withoutGlobalScopes();
    }
