...
class DeductionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return new RedirectResponse(route('biller.deductions.index'), ['flash_success' => 'Deduction Created Successfully']);
    }
    ...
    public function update(Request $request, deduction $deduction)
    {
        ...
        return new RedirectResponse(route('biller.deductions.index'), ['flash_success' => 'Deduction Updated Successfully!']);
    }
    ...
    public function destroy(Deduction $deduction, Request $request)
    {
        ...
        return new RedirectResponse(route('biller.deductions.index'), ['flash_success' => 'Deduction Deleted Successfully!']);
    }
