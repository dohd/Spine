...
class JobschedulesController extends Controller
{
    ...
    public function store(ManageJobscheduleRequest $request)
    {
        ...
        try {
            ...
            return new RedirectResponse(route('biller.jobschedules.index'), ['flash_error' => 'Error Creating Region']);
        }
    ...
    public function update(ManageRegionRequest $request, Branch $branch)
    {
        ...
        try {
            ...
            return new RedirectResponse(route('biller.branches.index'), ['flash_error' => 'Error Updating Branch']);
        }
        //return with successfull message
    ...
    public function destroy(Jobschedule $jobschedule, ManageJobscheduleRequest $request)
    {
        ...
        try {
            ...
            return new RedirectResponse(route('biller.jobschedules.index'), ['flash_error' => 'Error Deleting Job Schedule']);
        }
