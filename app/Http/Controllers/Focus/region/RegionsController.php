...
class RegionsController extends Controller
{
    ...
    public function store(ManageRegionRequest $request)
    {
        ...
        try {
            ...
            return new RedirectResponse(route('biller.regions.index'), ['flash_error' => 'Error Creating Region']);
        }
    ...
    public function update(ManageRegionRequest $request, Branch $branch)
    {
        ...
        try {
            ...
            return new RedirectResponse(route('biller.branches.index'), ['flash_success' => 'Error Updating Branch']);
        }
        //return with successfull message
