...
class BenefitController extends Controller
{
    ...
    public function update(Request $request, benefit $benefit)
    {
        ...
        return new RedirectResponse(route('biller.benefits.index'), ['flash_success' => 'Benefit Updated Successfully!!']);
    }
    ...
    public function destroy(Benefit $benefit, Request $request)
    {
        ...
        return new RedirectResponse(route('biller.benefits.index'), ['flash_success' => 'Benefit Deleted Successfully!!']);
    }
