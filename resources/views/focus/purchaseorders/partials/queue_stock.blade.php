<div class="tab-pane fade in" id="active4" aria-labelledby="active-tab4" role="tabpanel">
    <table class="table-responsive tfr my_stripe" id="quoteTbl">
        <thead>
            <tr class="item_header bg-gradient-directional-dark">
