                ...
                <form id="form_model_4">
                    <div class="row">
                        <div class="col mb-1"><label for="pmethod">LPO Date</label>
                            <input type="text" class="form-control mb-1" placeholder="LPO  Date" name="lpo_date" data-toggle="datepicker">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-1"><label for="note">LPO Amount</label>
                            <input type="text" class="form-control" name="lpo_amount" placeholder="LPO Amount" value="{{ @$words['pay_note']}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-1"><label for="note">LPO Number</label>
                            <input type="text" class="form-control" name="lpo_number" placeholder="LPO Number" value="{{ @$words['pay_note']}}">
                        </div>
                    </div>
