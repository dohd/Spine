                ...
                <form id="send_sms">
                    <div class="row">
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Mobile" name="sms_to" value="{{@$invoice->customer->phone}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col mb-1"><label for="contents">{{trans('general.body')}}</label>
                            <textarea name="text" title="Contents" id="sms_message" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <input type="hidden" id="bill_id" name="bill_id" value="{{$invoice['id']}}">
                    <input type="hidden" id="sms_template_type" name="template_type" value="">
