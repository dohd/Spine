...
<div class="content-wrapper">
    ...
    <div class="content-body">
            <div class="card">
                <div class="card-body">
                {{ Form::open(['route' => 'biller.quotes.store', 'class' => 'form-horizontal', 'method' => 'POST']) }}
                    <div class="row">
    ...
    function productRow(n) {
        return `
            <tr>
                ...
                <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-${n}" onchange="qtyChange(event)" /></td>
                <td><input type="text" class="form-control req prc" name="product_price[]" id="price-${n}" onchange="priceChange(event)" /></td>
                ...
                <input type="hidden" name="product_id[]" id="productid-${n}" value="0" />
    ...
    function productTitleRow(n) {
        return `
            <tr>
                ...
                <td class="text-center">${dropDown()}</td>
                <input type="hidden" name="product_id[]" value="${n}" id="customfieldid-${n}" />
