...
@section('content')
    <div class="">
        <div class="content-wrapper">
            <div class="content-body">
                          ...
                          <form method="post" id="data_form">
                                <div class="row">
                                    <div class="col-sm-6 cmp-pnl">
                                        ...
                                        data-placeholder="No Lead Selected" >
                                   ...
                                   $name=$lead->client_name;
                                    ...
                                    @endphp
                                        <option value="{{$lead['id']}}">{{$lead['reference']}} - {{$name}} -{{dateFormat($lead->date_of_request)}} -{{$lead->employee_id}} -  {{$lead->title}}</option>
                                    @endforeach
                                </select>
                                                    </div>
                                                </div>
                ...
                <div class="d-inline-block custom-control custom-checkbox mr-1">
                    <input type="radio" class="custom-control-input bg-primary" name="print_type" id="colorCheck6"
                           value="inclusive" checked="">
                    <label class="custom-control-label" for="colorCheck6">VAT Inclusive</label>
                </div>

                <div class="d-inline-block custom-control custom-checkbox mr-1">
                    <input type="radio" class="custom-control-input bg-purple" name="print_type" value="exclusive" 
                           id="colorCheck7">
       ...
       <div class="col-sm-3"><label for="pricing"
                                                                             class="caption"> Pricing</label>
                                               ...
                                               <div class="form-group row">
                                                   ...
                                                   <div class="col-sm-6"><label for="attention"
                                                                             class="caption"> Attention</label>
 ...
 {{ Form::text('prepaired_by', null, ['class' => 'form-control round required', 'placeholder' => 'Prepaired By','autocomplete'=>'false','id'=>'prepaired_by']) }}
                                        ...
                                        <div class="inner-cmp-pnl">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4"><label for="valid_till"
                                                                             class="caption">Validity Period</label>
                                                     ...
                                                     <div class="input-group">
                                                       ...
                                                       <select class="form-control round  select-box" name="validity" id="employee"
                  ...
                  <option value="90">Valid For  90 Days</option>
                                                     ...
                                                     <div class="col-sm-4"><label for="ref_type"
                                                    ...
                                                    <div class="input-group">
                                                       ...
                                                       <select class="form-control  select-box " name="currency" id="currency"
                                        data-placeholder="{{trans('tasks.assign')}}" >
                                   ...
                                   @foreach($currencies as $currency)
                                                  ...
                                                  <div class="col-sm-4"><label for="conversion_rate"
                                                                             class="caption">Conversion Rate</label>

                                                    <div class="input-group">
                                                        <div class="input-group-addon"><span class="icon-bookmark-o"
                                                                                             aria-hidden="true"></span>
                                                        </div>
                                                        {{ Form::text('conversion_rate', null, ['class' => 'form-control round', 'placeholder' => 'Conversion Rate']) }}
                                                    </div>
                                                </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-4"><label for="source"
                                                                             class="caption">Quotation Terms*</label>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><span class="icon-file-text-o"
                                                         ...
                                                         <select id="items" name="term_id" 
                                                    class="form-control round  selectpicker required  ">
                                ...
                                <div id="saman-row">
                                    ...
                                    <td><select class="form-control unit" data-uid="0" name="u_m[]"
                                                 ...
                                                 <td><input type="text" class="form-control req amnt" name="product_qty[]"
                                                       ...
                                                       onkeyup="qtRowTotal('0'), qtyBillUpyog()"
                                                       autocomplete="off" ><input type="hidden" id="alert-0"
                                                                                           value=""
                                                                                           name="alert[]"></td>
                                            <td><input type="text" class="form-control req prc" name="product_price[]"
                                                       ...
                                                       <td><input type="text" class="form-control req prcrate" name="rate_inclusive[]"
                                                       id="rate_inclusive-0" autocomplete="off" readonly></td>
...
>
                                           ...
                                           <input type="hidden"  name="product_exclusive[]" id="totalinc-0"
                                                   value="0">
