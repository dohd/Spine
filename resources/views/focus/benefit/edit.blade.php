...
@section ('title', 'Benefits Management' . ' | ' . 'Edit')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($benefits, ['route' => ['biller.benefits.update', $benefits], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-department']) }}

                                    <div class="form-group">
                                        {{-- Including Form blade file --}}
                                        @include("focus.benefit.form")
                                        <div class="edit-form-btn">
                                            {{ link_to_route('biller.benefits.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-danger btn-md']) }}
