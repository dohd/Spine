<div class="card">
   <div class="card-content">
    <div class="card-body">
        <div class="row">
            <div class="col-4">
                {{ Form::label( 'name', 'Toolkit Name',['class' => 'col control-label']) }}
                    <div class='col'>
        ...
        <table id="itemTbl" class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="form-control quant" name="quantity[]" placeholder="0.00" id="quant-0"></td>
                    <td><select name="uom[]"  id="uom-0" class="form-control uom"></select></td>
                    <td><input type="text" class="form-control code" name="code[]" placeholder="0.00" id="code-0"></td>
