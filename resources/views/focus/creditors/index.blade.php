        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0"> Creditors List </h4>
            ...
            @if($segment)
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p>{{amountFormat($segment->sum('credit')-$segment->sum('debit'))}}</p>
                                </div>
                            </div>
                   ...
                   <div class="card p-1 bg-lighten-5">
                    <h4 class="mb-0">{{$supplier->company}} Transactions </h4>
...
@section('after-scripts')
    ...
    <script>
        ...
        function draw_data() {
            ...
            var dataTable = $('#creditors-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: '{{ route("biller.creditors.get") }}',
                    type: 'post'
                },
                columns: [
            ...
            $('#creditors-table_wrapper').removeClass('form-inline');
