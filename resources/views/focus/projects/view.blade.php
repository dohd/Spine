            ...
            <div class="card-content">
                <div class="card-body" id="pro_tabs">
                    <ul class="nav nav-tabs nav-top-border no-hover-bg" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab1" data-toggle="tab" href="#tab_data1" aria-controls="tab_data1" role="tab" aria-selected="true"><i class="fa fa-lightbulb-o"></i> {{trans('projects.project_summary')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab2" data-toggle="tab" href="#tab_data2" aria-controls="tab_data2" role="tab" aria-selected="true"><i class="fa fa-flag-checkered"></i> {{trans('projects.milestones')}}</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content px-1 pt-1">
                                ...
                                <div class="card-head">
                                    ...
                                    <div class="px-1">
                                        ...
                                        <ul class="list-inline list-inline-pipe text-center p-1 border-bottom-grey border-bottom-lighten-3">
                                            ...
                                            @if($project->worth>0.00) <li>{{trans('projects.worth')}}: <span class="text-bold-600 primary">{{amountFormat($project->worth)}}</span>
                                            </li>
                                            @endif
                                        </ul>
                                        <ul class="list-inline list-inline-pipe text-center p-1 border-bottom-grey border-bottom-lighten-3">
                                            <li>{{trans('projects.start_date')}}: <span class=" text-bold-600 purple">{{dateTimeFormat($project['start_date'])}}</span>
                                            </li>
                                            <li>{{trans('projects.end_date')}}: <span class="text-bold-600 danger">{{dateTimeFormat($project['end_date'])}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div id="project-info" class="card-body row">
                                    ...
                                    <div class="project-info-count col-lg-3 col-md-12">
                                        ...
                                        <div class="project-info-text pt-1">
                                            ...
                                            <input type="range" min="0" max="100" value="{{$project['progress']}}" class="slider" id="progress">
                                        </div>
                                    </div>
                                    <div class="project-info-count col-lg-3 col-md-12">
                                        <div class="project-info-icon">
                        ...
                        <div class="tab-pane" id="tab_data2" aria-labelledby="tab2" role="tabpanel">
                            ...
                            <ul class="timeline">
                                ...
                                <li class="@if (!$flag) timeline-inverted @endif " id="m_{{$row['id']}}">
                                    <div class="timeline-badge" style="background-color:@if ($row['color']) {{$row['color']}} @else #0b97f4  @endif;">{{$total}}</div>
                                    <div class="timeline-panel">
                                        ...
                                        <div class="timeline-body mb-1">
                                            <p>{{$row['note']}}</p><a href="#" class=" delete-object" data-object-type="2" data-object-id="{{$row['id']}}"><i class="danger fa fa-trash"></i></a>
                                        </div>
                                        @endif
                        ...
                        <div class="tab-pane" id="tab_data4" aria-labelledby="tab4" role="tabpanel">
                            @if(project_access($project->id))
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#AddLogModal">
                                {{trans('general.new')}}
                            </button>
                            <div class="card-body">
                        ...
                        <div class="tab-pane" id="tab_data5" aria-labelledby="tab5" role="tabpanel">
                            ...
                            <table id="files" class="files table table-striped mt-2">
                                ...
                                <tr>
                                    <td>
                                        <a data-url="{{route('biller.project_attachment')}}?op=delete&id={{$row['id']}}" class="aj_delete red"><i class="btn-sm fa fa-trash"></i></a> <a href="{{ Storage::disk('public')->url('app/public/files/' . $row['value']) }}" class="purple"><i class="btn-sm fa fa-eye"></i> {{$row['value']}}</a>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                        ...
                        <div class="tab-pane" id="tab_data7" aria-labelledby="tab7" role="tabpanel">
                            ...
                            <div class="card-body">
                                <table id="invoices-table_p" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                        ...
                                        <div class="card-body  py-0 px-0">
                                            <div class="list-group">
                                                ...
                                                <a href="javascript:void(0)" class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left pr-1"><span class="avatar avatar-sm"><img src="{{ Storage::disk('public')->url('app/public/img/users/' . @$row->picture) }}"><i></i></span>
                                                        </div>
...
<script>
    $('#AddMileStoneModal').on('shown.bs.modal', function() {
        ...
        $('.from_date').datepicker('setDate', '{{dateFormat(date('
        ...
        $('#fileupload').fileupload({
                ...
                formData: {
                    ...
                    $.each(data.result, function(index, file) {
                        $('#files').append('<tr><td><a data-url="{{route('
                            biller.project_attachment ')}}?op=delete&id= ' + file.id + ' " class="aj_delete red"><i class="btn-sm fa fa-trash"></i></a> ' + file.name + ' </td></tr>');
                    });
                },
