                        ...
                        <div class="row">
                            <fieldset class="form-group col-8">
                             ...
                             <fieldset class="form-group col-4">
                                <input type="text" class="new-todo-item form-control required"
                                       placeholder="Project Number" name="project_number">
                            </fieldset>
                        </div>
                        <div class="row">
                            <fieldset class="form-group col-md-4">
                                <input type="text" class="new-todo-item form-control"
                                       placeholder="LPO Amount" name="lpo_amount">
                            </fieldset>

                            <fieldset class="form-group col-md-4">
                                <input type="text" class="new-todo-item form-control"
                                       placeholder="LPO Number" name="lpo_number">
                            </fieldset>
                             <fieldset class="form-group col-md-4">

                                   <select class="form-control  select-box" name="sales_account" id="sales_account"
                                        data-placeholder="Project Type/Sales Account" >
