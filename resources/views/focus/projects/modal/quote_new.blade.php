<div class="modal" id="AddQuoteModal" tabindex="-1" role="dialog" aria-labelledby="AddQuoteLabel"
     aria-hidden="true">
                ...
                <form id="data_form_quote" class="quote-input">
                    ...
                    <div class="modal-footer">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <button type="button" id="submit-data_quote" class="btn btn-info add-quote-item"
