            ...
            <section class="todo-form">
                <form id="data_form_task_view" class="todo-input">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewModalLabel">{{trans('projects.project')}} : <b><span id="p_name"></span></b></h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            {{-- hide project end_date 
                            <div class="col-md-3">{{trans('projects.end_date')}} <span class="font-weight-bold" id="p_end"></span></div>
                            --}}
                        ...
                        {{-- Hide owners and users
                        <hr>
                        <div class="row">
                            <div class="col-md-6">{{trans('projects.owner')}} <span class="font-weight-bold" id="p_creator"></span></div>
                            <div class="col-md-6">{{trans('projects.users')}} <span class="font-weight-bold" id="p_assigned"></span></div>
                        </div>
                        <hr>                        
                        <hr>
                        --}}
