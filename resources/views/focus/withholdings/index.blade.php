...
@section('page-header')
    <h1>WithHolding Tax  Management</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">WithHolding Tax  Management</h4>
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#withholdings-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
            ...
            $('#withholdings-table_wrapper').removeClass('form-inline');
