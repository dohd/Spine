                                ...
                                <div class="col-sm-6 cmp-pnl">
                                    <div id="customerpanel" class="inner-cmp-pnl">
                                        <div class="form-group row">
                                            <div class="col-sm-8"><label for="payer" class="caption">Customer Name*</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6"><label for="refer_no" class="caption">Bank Account*</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span>
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6"><label for="refer_no" class="caption">Ledger Account Asset(Debit)*</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span>
                                                    </div>
                                                    <select name="dr_account_id" class="form-control round required" id="dr_account_id">
                                            ...
                                            <div class="col-sm-6"><label for="tid" class="caption">Ledger
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="cr_account_id" class="form-control round required" id="cr_account_id">
                                                        <option value="">Select Ledger Account</option>
                                ...
                                <div class="col-sm-6 cmp-pnl">
                                    <div class="inner-cmp-pnl">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4"><label for="invoice_no" class="caption">Invoice Number*</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span>
                                                    </div>
                                            ...
                                            {{-- 
                                                <div class="col-sm-4"><label for="lpo_ref" class="caption">LPO Ref*</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span>
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6"><label for="invoicedate" class="caption">Invoice Date*</label>
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                {{ Form::textarea('notes', null, ['class' => 'form-control round text-danger', 'placeholder' => trans('general.note'), 'rows' => '2']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
