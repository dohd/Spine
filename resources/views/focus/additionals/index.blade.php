...
@section('page-header')
    <h1>{{ trans('labels.backend.additionals.management') }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="">{{ trans('labels.backend.additionals.management') }}</h4>
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#additionals-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
            ...
            $('#additionals-table_wrapper').removeClass('form-inline');
