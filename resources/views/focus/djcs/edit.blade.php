...
@section('page-header')
    <h1>
        Diagnosis Job Card
        <small>Edit Diagnosis Job Card</small>
    </h1>
@endsection
...
@section('content')
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">            
                          ...
                          {{ Form::model($djcs, ['route' => ['biller.djcs.update', $djcs], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-product']) }}
                                            ...
                                            <div class="form-group row">
                                                <div class="fcol-sm-12">
                                                    <h3 class="title"> Djc Details 
                                                     ...
                                                     <div class="form-group row">
                                               <div class="col-sm-12"><label for="ref_type"
                                                                             class="caption">Search Lead </label>
                                                    ...
                                                    <div class="input-group">
                                                       ...
                                                       <select class="form-control  round  select-box" name="lead_id" id="lead_id"
                                        data-placeholder="{{trans('tasks.assign')}}" required="required" >
                            ...
                            <input type="hidden" name="branch_id" id="branch_id">
                                              ...
                                              <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <label for="attention"
                                                           class="attention">Attention</label>
                                                 ...
                                                 <div class="col-sm-4"><label for="reference"
                                                  ...
                                                  <div class="col-sm-4"><label for="report_date"
                                                                             class="caption">Report {{trans('general.date')}}</label>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <label for="region"
                                                           class="caption"> Region</label>
 {{ Form::text('region', null, ['class' => 'form-control round ', 'placeholder' => 'Region','autocomplete'=>'false','id'=>'region']) }}
                                                </div>
                                                  <div class="col-sm-4"><label for="prepared_by"
                                                                             class="caption">Prepaired By</label>
                                                  ...
                                                  <div class="col-sm-4">
                                                    <label for="technician"
                                                           class="caption"> Techinican</label>
 {{ Form::text('technician', null, ['class' => 'form-control round required', 'placeholder' => 'Technician','autocomplete'=>'false','id'=>'prepaired_by','required' => 'required']) }}
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="col-sm-3"><label for="client_name"
                                                                             class="caption"> Image 1 </label>
                                                ...
                                                <div class="col-sm-3"><label for="client_email"
                                                                             class="caption"> Image 2</label>
                                                ...
                                                <div class="col-sm-3"><label for="caption"
                                                                             class="caption"> Caption 1 </label>
                                                ...
                                                <div class="col-sm-3"><label for="client_email"
                                                   ...
                                                   <div class="col-sm-3"><label for="caption_three"
                                                                             class="caption"> Caption 3</label>
                                    ...
                                    <div class="col-sm-6 cmp-pnl">
                                        <div class="inner-cmp-pnl">
                                             ...
                                             <div class="form-group row">
                                               ...
                                               <div class="col-sm-12">
                                                    <label for="toAddInfo"
                                                           class="root_cause">Findings and Root Cause</label>
                                               ...
                                               <div class="col-sm-12">
                                                    <label for="toAddInfo"
                                                           class="action_taken">Action Taken</label>
                                               ...
                                               <div class="col-sm-12">
                                                    <label for="toAddInfo"
                                                           class="recommendations">Recommendations</label>
                                    ...
                                    <table id="quotation" class="table-responsive tfr my_stripe_single" style="padding-bottom: 100px;">
                                        ...
                                        <tbody>
                                        <tr>
                                           <td><input type="text" class="form-control" name="tag_number[]"
                                                       placeholder="Search Equipment"
                                                       id='tag_number-0' required="required">
                                            </td>
                                           
                                

                                                 <td><input type="text" class="form-control req amnt" name="joc_card[]"
                                                       id="joc_card-0" autocomplete="off" ></td>
                                                <td><input type="text" class="form-control req prc" name="equipment_type[]"
                                                       id="equipment_type-0"autocomplete="off"></td>
                                            <td><input type="text" class="form-control r" name="make[]"
                                                       id="make-0" autocomplete="off"></td>

                                           <td><input type="text" class="form-control req" name="capacity[]"
                                                       id="capacity-0" autocomplete="off" ></td>

 
                                            <td><input type="text" class="form-control req" name="location[]"
                                                       id="location-0" autocomplete="off" ></td>
                                             <td><input type="text" class="form-control req" name="last_service_date[]"
                                                       id="last_service_date-0" autocomplete="off" data-toggle="datepicker"></td>
                                        <td><input type="text" class="form-control req" name="next_service_date[]"
                                                       id="next_service_date-0" autocomplete="off" data-toggle="datepicker" ></td>
               ...
               <button type="button" class="btn btn-success" aria-label="Left Align"
                        ...
                        <div class="edit-form-btn mt-2">
                                ...
                                @if($defaults[4][0]->ship_tax['id']>0) 
                                    <input type='hidden' value="{{numberFormat($defaults[4][0]->ship_tax['value'])}}" name='ship_rate' id='ship_rate'>
                                    <input type='hidden' value="{{$defaults[4][0]->ship_tax['type2']}}" name='ship_tax_type' id='ship_taxtype'>
                                @else
                                    <input type='hidden' value='{{numberFormat(0)}}' ame='ship_rate' id='ship_rate'>
                                    <input type='hidden' value='none' name='ship_tax_type' id='ship_taxtype'>
                                @endif
...
<script type="text/javascript">
    ...
    $('#addqproduct').on('click', function () {
        ...
        //product row
        var data = '<tr><td><input type="text" class="form-control required"  required="required" name="tag_number[]" placeholder="Search Equipment" id="tag_number-' + cvalue + '" autocomplete="off"></td><td><input type="text" class="form-control req amnt" name="joc_card[]" id="joc_card-' + cvalue + '" autocomplete="off" ></td><td><input type="text" class="form-control req prc" name="equipment_type[]" id="equipment_type-' + cvalue + '"autocomplete="off"> </td><td><input type="text" class="form-control r" name="make[]" id="make-' + cvalue + '" autocomplete="off"></td><td><input type="text" class="form-control req" name="capacity[]" id="capacity-' + cvalue + '" autocomplete="off" ></td><td><input type="text" class="form-control req" name="location[]" id="location-' + cvalue + '" autocomplete="off" ></td><td><input type="text" class="form-control req" name="last_service_date[]" id="last_service_date-' + cvalue + '" autocomplete="off" data-toggle-' + cvalue + '="datepicker"></td><td><input type="text" class="form-control req" name="next_service_date[]" id="next_service_date-' + cvalue + '" autocomplete="off" data-toggle-' + cvalue + '="datepicker"></td><td class="text-center"><div class="dropdown"><button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><a class="dropdown-item removeProd" href="javascript:void(0);" data-rowid="' + cvalue + '" >Remove</a><a class="dropdown-item up" href="javascript:void(0);">Up</a><a class="dropdown-item down" href="javascript:void(0);">Down</a></div></div></td></tr>';
