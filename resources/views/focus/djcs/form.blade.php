    ...
    <div class="col-sm-6 cmp-pnl">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6"><label for="ref_type" class="caption">Branch</label>
                    <div class="input-group">
                        ...
                        <select id="branch_id" name="branch_id" class="form-control  select-box"  data-placeholder="Branch" ></select>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6 cmp-pnl">
            <div class="inner-cmp-pnl">
                ...
                <div class="col-sm-6"><label for="ref_type" class="caption">Assign To*</label>
                    <div class="input-group">
                        <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
                            <select class="form-control  select-box" name="employee_id" id="employee" data-placeholder="{{trans('tasks.assign')}}" >
...
<script type="text/javascript">
    ...
    $("input[name=client_status]").on('change', function () {
        const payerType = $('input[name=client_status]:checked').val();
