    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                    ...
                    <ul class="dropdown-menu">
                                ...
                                <ul class="dropdown-menu">
                                    @permission('manage-djc')
                                        <li><a class="dropdown-item" href="{{ route('biller.djcs.index') }}"
                                                data-toggle="dropdown"> <i class="fa fa-compass"></i> Manage Djc Report</a>
                                        </li>
                                    @endauth
                        ...
                        @permission('manage-pi')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-file-text"></i>PI Management</a>
                                <ul class="dropdown-menu">
                                    @permission('manage-pi')
                                        <li><a class="dropdown-item" href="{{ route('biller.quotes.index', 'page=pi') }}"
                                                data-toggle="dropdown"><i class="ft-list"></i> Manage PI </a></li>
                                    @endauth
                                    @permission('create-pi')
                                        <li><a class="dropdown-item" href="{{ route('biller.quotes.create', 'page=pi') }}"
                                                data-toggle="dropdown"><i class="fa fa-plus-circle"></i> Create PI</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.quotes.create', 'page=pi&doc_type=maintenance') }}"
                                                data-toggle="dropdown"><i class="fa fa-plus-circle"></i> Maintenance PI</a>
                                        </li>
                                    @endauth
                                </ul>
                            </li>
                        ...
                        @permission('manage-rjc')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="icon-tag"></i> Rjc Report</a>
                                <ul class="dropdown-menu">
                                    @permission('manage-rjc')
                                        <li><a class="dropdown-item" href="{{ route('biller.rjcs.index') }}"
                                                data-toggle="dropdown"> <i class="fa fa-compass"></i> Manage Rjc Report</a>
                                        </li>
                                    @endauth
            ...
            @if (access()->allow('stock'))
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                        href="#" data-toggle="dropdown"><i class="ft-layers"></i><span>Inventory</span></a>
                    <ul class="dropdown-menu">
                        {{-- stock issuance --}}
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-issuance')
                                        <li><a class="dropdown-item" href="{{ route('biller.projectstock.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Stock
                                                Issuance </a></li>
                                    @endauth
                                </ul>
                            </li>
                        ...
                        @permission('manage-opening-stock')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-balance-scale"></i> Product Opening Stock</a>
                                <ul class="dropdown-menu">
                                    <li>
                                    ...
                                    @permission('create-opening-stock')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('biller.opening_stock.create') }}"
                                                data-toggle="dropdown"><i class="fa fa-plus-circle"></i> Create Opening
                                                Stock</a>
                                        </li>
                                    @endauth
                                </ul>
                        ...
                        @permission('manage-product-category')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-object-ungroup"></i> Product Categories
                                </a>
                                <ul class="dropdown-menu">
                        ...
                        @permission('manage-warehouse')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-building-o"></i> Product Location
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('biller.warehouses.index') }}"
                                            data-toggle="dropdown"> <i class="ft-list"></i> Location Management
                                        </a>
                                    </li>
                                    @permission('create-warehouse')
                                        <li><a class="dropdown-item" href="{{ route('biller.warehouses.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Location
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                        ...
                        @permission('manage-stock-transfer')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-wind"></i> {{ trans('products.stock_transfer') }}
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('biller.stock_transfers.index') }}"
                                            data-toggle="dropdown"> <i class="ft-list"></i> Transfer Management
                                        </a>
                                    </li>
                                    @permission('create-stock-transfer')
                                        <li><a class="dropdown-item" href="{{ route('biller.stock_transfers.create') }}"
            ...
            @if (access()->allow('finance'))
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                        href="#" data-toggle="dropdown"><i class="fa fa-tags"></i><span>Procurement</span></a>
                    <ul class="dropdown-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-purchase')
                                        <li><a class="dropdown-item" href="{{ route('biller.purchases.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Direct
                                                Purchase
                                            </a>
                                        </li>
                                    @endauth
                                    ...
                                    @permission('create-purchase')
                                        <li><a class="dropdown-item" href="{{ route('biller.purchaseorders.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Purchase
                                                Order
                                            </a>
                                        </li>
                                    @endauth
                        ...
                        @permission('manage-debit-note')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ route('biller.creditnotes.index') }}?is_debit=1"
                                            data-toggle="dropdown"><i class="ft-list"></i> Manage Debit Notes
                                        </a>
                                    </li>
                                    @permission('create-debit-note')
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.creditnotes.create') }}?is_debit=1"
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                    ...
                    <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-bill')
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.utility-bills.create_kra_bill') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i>Create KRA Bill</a>
                                        </li>
                                    @endauth
                                </ul>
                            </li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-invoice')
                                        <li><a class="dropdown-item" href="{{ route('biller.invoices.uninvoiced_quote') }}"
                                                data-toggle="dropdown"><i class="fa fa-plus-circle"></i> Create Project
                                                Invoice
                                            </a>
                                        </li>
                        ...
                        @permission('manage-withholding-cert')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-file"></i>Withhoding Certificate
                                </a>
                                <ul class="dropdown-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-account')
                                        <li><a class="dropdown-item" href="{{ route('biller.accounts.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Ledger
                                                Account
                                            </a>
                                        </li>
                                    @endauth
                                    <li><a class="dropdown-item" href="{{ route('biller.transactions.index') }}"
                                            data-toggle="dropdown"> <i class="fa fa-exchange"></i> Double Entry
                                            Transactions
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('biller.tax_reports.create') }}"
                                            data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Tax
                                            Return</a></li>
                                    <li><a class="dropdown-item "
                                            href="{{ route('biller.tax_reports.filed_report') }}"><i
            ...
            @if (access()->allow('finance'))
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                        href="#" data-toggle="dropdown"><i class="fa fa-bank"></i><span>Banking</span></a>
                    <ul class="dropdown-menu">
                        @permission('manage-bill')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                        ...
                        @permission('manage-invoice')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('biller.invoices.index_payment') }}"><i
                                                class="fa fa-money"></i> Manage Payments</a></li>
                                    @permission('create-invoice')
                                        <li><a class="dropdown-item" href="{{ route('biller.invoices.create_payment') }}"><i
            ...
            @if (access()->allow('maintenance-project'))
                <li class="dropdown nav-item" data-menu="dropdown">
                    <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i
                            class="fa fa-industry"></i><span>Project Management</span></a>
                    <ul class="dropdown-menu">
                        {{-- project --}}
                        @permission('manage-project')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-calendar"></i> Projects</a>
                                <ul class="dropdown-menu">
                                    <li>
                        ...
                        @permission('manage-quote-verify')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-file-text"></i> Partial Job Verification</a>
                                <ul class="dropdown-menu">
                        ...
                        @permission('manage-equipment')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="icon-tag"></i>Maintenance Equipments</a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('create-pm-contract')
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.contracts.create_add_equipment') }}"
                                    ...
                                    @permission('create-advance-payment')
                                        <li>
                                            <a class="dropdown-item" href="{{ route('biller.advance_payments.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i> Create Payment
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @permission('manage-project')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ '#' }}" data-toggle="dropdown">
                                            <i class="fa fa-compass"></i> IRD Report</a></li>
                                    <li><a class="dropdown-item" href="{{ '#' }}" data-toggle="dropdown">
                                            <i class="fa fa-plus-circle"></i> Create IRD Report</a></li>
                                </ul>
                            </li>
                        @endauth
                        ...
                        <ul class="drilldown-menu">
                            <li class="menu-list">
                                <ul class="mega-menu-sub">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{route('biller.import.general',['prospect'])}}">
